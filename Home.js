...
export default class HomeScreen extends Component {
  ...
  getMovie = () => {
    const url = "http://2e1b255b71aa.ngrok.io/get-movie";
    axios
      .get(url)
      .then(response => {
  ...
  likedMovie = () => {
    const url = "http://2e1b255b71aa.ngrok.io/liked-movie";
    axios
      .post(url)
      .then(response => {
        this.getMovie();
  ...
  unlikedMovie = () => {
    const url = "http://2e1b255b71aa.ngrok.io/unliked-movie";
    axios
      .post(url)
      .then(response => {
        this.getMovie();
  ...
  notWatched = () => {
    const url = "http://2e1b255b71aa.ngrok.io/did-not-watch";
    axios
      .post(url)
      .then(response => {
        this.getMovie();
